...
import "./highlight/cm/codemirror.js?260827";
import "./highlight/cm/scrollpastend.js?260827";
import "./highlight/cm/mark-selection.js?260827";
import "./highlight/cm/active-line.js?260827";
import "./highlight/cm/sami.js?260827";

{
	let link = document.createElement("link");
	link.rel = "stylesheet";
	link.href = new URL("./SmiEditor.css?260827", import.meta.url).href;
	document.head.append(link);
	
	link = document.createElement("link");
	link.rel = "stylesheet";
	link.href = new URL("./highlight/cm/codemirror.css?260827", import.meta.url).href;
	document.head.append(link);
}
...
SmiEditor.Finder = {
	...
	,	open: function(isReplace) {
			...
			let newWindow = window.open("finder.html?260827", "finder", "scrollbars=no,location=no,width=400,height=220");
...
SmiEditor.Viewer = {
		window: null
	,	open: function() {
			let newWindow = window.open("viewer.html?260827", "viewer", "scrollbars=no,location=no,width=1,height=1");
