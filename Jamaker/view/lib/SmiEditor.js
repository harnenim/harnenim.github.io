...
SmiEditor.Finder = {
	...
	,	open: function(isReplace) {
			...
			this.window = window.open("finder.html?241205.2", "finder", "scrollbars=no,location=no,width="+w+",height="+h);
...
SmiEditor.Viewer = {
		window: null
	,	open: function() {
			this.window = window.open("viewer.html?241205.2", "viewer", "scrollbars=no,location=no,width=1,height=1");
...
SmiEditor.Addon = {
	...
	,	open: function(name, target="addon") {
			var url = (name.substring(0, 4) == "http") ? name : "addon/" + name.split("..").join("").split(":").join("") + ".html?241205.2";
	...
	,	openExtSubmit: function(method, url, values) {
			...
			this.windows.addon = window.open("addon/ExtSubmit.html?241205.2", "addon", "scrollbars=no,location=no,width=1,height=1");
			setTimeout(function() {
